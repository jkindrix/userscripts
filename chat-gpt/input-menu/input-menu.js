...
the prompt in the Revised prompt section until I say we are done.\n\n`;
  ...
  async function androidDevelopmentEnvironment() {
    const prompt = `In an Android app that's already setup, configured, and verified fully working to use Kotlin, Jetpack Compose, Navigation Compose, StateFlows, Material3, KSP, DataStores, Hilt, Room, and Retrofit with an MVVM architecture, what is the best practice way to handle the following:\n\n`;
    await appendText(prompt);
  }
